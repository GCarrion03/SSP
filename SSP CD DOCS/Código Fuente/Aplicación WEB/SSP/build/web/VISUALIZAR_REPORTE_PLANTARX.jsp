...
<jsp:useBean id="beanrreporte" class="SSP_CAPAS.GMPresentacion" scope="request" >
 ...
 <%
    ...
    JasperDesign jasperDesign = JRXmlLoader.load(getServletContext().getRealPath("reportes/ReportejasperREDX.jrxml"));
    JRDesignQuery query = new JRDesignQuery();
    //query.setText("select * from historico_problema");
    query.setText("{ call DBO.REPORTELISTARX('"+request.getParameter("txt_fini")+"','"+request.getParameter("txt_ffin")+"','"+tipo_doc+"','"+plataforma+"','"+area+"')}");
...
if (request.getParameter("btn_reporte")!=null)
    ...
    if (request.getParameter("cmb_treport").compareTo("1")==0 ){
        archivojrxml="reportes/RESUMEN_PLANTAREDX.jrxml";
        cadsql="{ call DBO.REPORTERXAREA ('"+request.getParameter("txt_fini")+"','"+request.getParameter("txt_ffin")+"','"+tipo_doc+"','"+plataforma+"','"+area+"')}";
    }
    String Cadenarpttop10="{call DBO.REPORTELISTATOP10RX('"+request.getParameter("txt_fini")+"','"+request.getParameter("txt_ffin")+"','"+tipo_doc+"','"+plataforma+"','"+area+"')}";
    System.out.println(cadsql);
    JasperReport jasperReport;
    JasperReport jasperReporttop;
    JasperPrint jasperPrint;
    JasperPrint jasperPrinttop;
    JasperDesign jasperDesign = JRXmlLoader.load(getServletContext().getRealPath("reportes/RESUMEN_PLANTAREDX.jrxml"));
