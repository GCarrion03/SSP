...
if (request.getParameter("btn_reporte")!=null)
    ...
    if (request.getParameter("cmb_treport").compareTo("1")==0 ){
        archivojrxml="reportes/RESUMEN_PLANTABC.jrxml";
        cadsql="{ call DBO.REPORTEBCAREA ('"+request.getParameter("txt_fini")+"','"+request.getParameter("txt_ffin")+"','"+tipo_doc+"','"+turno+"','"+escalonamiento+"','"+plataforma+"','"+punto_apertura+"','"+ponderacion+"','"+area+"','"+lider_grupo+"') }";
    }
    if (request.getParameter("cmb_treport").compareTo("2")==0){
        archivojrxml="reportes/RESUMEN_PLANTABC.jrxml";
        cadsql="{ call DBO.REPORTEBCLIDERG ('"+request.getParameter("txt_fini")+"','"+request.getParameter("txt_ffin")+"','"+tipo_doc+"','"+turno+"','"+escalonamiento+"','"+plataforma+"','"+punto_apertura+"','"+ponderacion+"','"+area+"','"+lider_grupo+"') }";
        }
    if (request.getParameter("cmb_treport").compareTo("3")==0){
        archivojrxml="reportes/RESUMEN_PLANTABC.jrxml";
        cadsql="{ call DBO.REPORTEBCPTOAP ('"+request.getParameter("txt_fini")+"','"+request.getParameter("txt_ffin")+"','"+tipo_doc+"','"+turno+"','"+escalonamiento+"','"+plataforma+"','"+punto_apertura+"','"+ponderacion+"','"+area+"','"+lider_grupo+"') }";
        }
    if (request.getParameter("cmb_treport").compareTo("4")==0){
        archivojrxml="reportes/RESUMEN_PLANTABC.jrxml";
        cadsql="{ call DBO.REPORTEBCCORR ('"+request.getParameter("txt_fini")+"','"+request.getParameter("txt_ffin")+"','"+tipo_doc+"','"+turno+"','"+escalonamiento+"','"+plataforma+"','"+punto_apertura+"','"+ponderacion+"','"+area+"','"+lider_grupo+"') }";
        }
    String Cadenarpttop10="{ call DBO.REPORTELISTATOP10('"+request.getParameter("txt_fini")+"','"+request.getParameter("txt_ffin")+"','"+tipo_doc+"','"+turno+"','"+escalonamiento+"','"+plataforma+"','"+punto_apertura+"','"+ponderacion+"','"+area+"','"+lider_grupo+"' )}";
    JasperReport jasperReport;
    JasperReport jasperReporttop;
    JasperPrint jasperPrint;
    JasperPrint jasperPrinttop;
    JasperDesign jasperDesign = JRXmlLoader.load(getServletContext().getRealPath("reportes/RESUMEN_PLANTABC.jrxml"));
