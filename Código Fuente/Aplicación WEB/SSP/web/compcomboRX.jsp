...
<%=mibean4.AJX_CARGAID_DOCRX(request.getParameter("Id"),request.getParameter("control"), request.getParameter("SProc"))%>
<%//cogemos valores de la bdd
}
...
<%=mibean4.AJX_NIVMNTN2(request.getParameter("Id"),request.getParameter("Id2"),request.getParameter("Id3"),request.getParameter("control"), request.getParameter("SProc"),"div_cmbpos","cmb_pos","DEVOLVER_POST","1","compcomboRX")%>
<%//cogemos valores de la bdd
}
if((request.getParameter("Id")!=null) && request.getParameter("control").equals("cmb_niv1")){%>
<%=
mibean4.AJX_NIVSPMODRXN1(request.getParameter("Id"),request.getParameter("Id2"), request.getParameter("control"), request.getParameter("SProc"),"div_cmbniv2","cmb_niv2","DEVOLVER_N2","1")%>
        <%//cogemos valores de la bdd
}
if((request.getParameter("Id")!=null) && request.getParameter("control").equals("cmd_defecto")){%>
<%=
mibean4.AJX_NIVMNTFALLO(request.getParameter("Id"), request.getParameter("control"),"cmb_categoria", request.getParameter("SProc"),"div_cmbniv1","cmb_niv1","DEVOLVER_N1","1","compcomboRX")%>
<%//cogemos valores de la bdd
}
