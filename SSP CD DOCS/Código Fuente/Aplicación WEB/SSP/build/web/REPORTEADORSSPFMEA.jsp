...
%>
    ...
    <form name="formdoc"  method="post" action="VISUALIZAR_REPORTE_PLANTAFMEA.jsp?tipo_d=<%=request.getParameter("tipo_d")%>" >
            ...
            <table width="100%" height="136" border="0" align="center">
	          ...
	          <option selected value="<%=beanprincipal.devuelve_commakey("DEVUELVEPTOAP()")%>">Todos</option>
                <%=beanprincipal.devuelve_dept()%>
                    ...
                    <td align="left" width="51%"><fieldset class="fieldset">
                <legend>Área:</legend><select name="txt_Area" size="6" multiple id="txt_Area"  style="width:100%">
